...
namespace Tracker.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BillController : Tracker.Areas.Admin.Controllers.BillController
    {
        ...
        [NonAction]
        partial void DownloadOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.Areas.Admin.Models.BillModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Download(long id, Tracker.Areas.Admin.Models.BillModel model)
        {
        ...
        [NonAction]
        partial void SaveOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.Areas.Admin.Models.BillModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Save(long id, Tracker.Areas.Admin.Models.BillModel model)
        {
