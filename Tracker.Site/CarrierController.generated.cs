...
namespace Tracker.Controllers.User
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CarrierController : Tracker.Controllers.User.CarrierController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.ViewModels.User.CarrierModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Tracker.ViewModels.User.CarrierModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.User.CarrierModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long id, Tracker.ViewModels.User.CarrierModel model)
        {
