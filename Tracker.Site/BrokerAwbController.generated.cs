...
namespace Tracker.Controllers.Awb
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BrokerAwbController : Tracker.Controllers.Awb.BrokerAwbController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.AirWaybill.AwbBrokerModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long id, Tracker.ViewModels.AirWaybill.AwbBrokerModel model)
        {
