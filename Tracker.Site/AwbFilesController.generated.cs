...
namespace Tracker.Controllers.Awb
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AwbFilesController : Tracker.Controllers.Awb.AwbFilesController
    {
        ...
        [NonAction]
        partial void FilesOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, long id, Tracker.DataAccess.Contracts.Enums.AwbFileType type);

        [NonAction]
        public override System.Web.Mvc.JsonResult Files(long id, Tracker.DataAccess.Contracts.Enums.AwbFileType type)
        {
        ...
        [NonAction]
        partial void UploadOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, long id, Tracker.DataAccess.Contracts.Enums.AwbFileType type, System.Web.HttpPostedFileBase file);

        [NonAction]
        public override System.Web.Mvc.JsonResult Upload(long id, Tracker.DataAccess.Contracts.Enums.AwbFileType type, System.Web.HttpPostedFileBase file)
        {
