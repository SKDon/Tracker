...
namespace Tracker.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Tracker.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void FeedbackOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.ViewModels.FeedbackModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Feedback(Tracker.ViewModels.FeedbackModel model)
        {
