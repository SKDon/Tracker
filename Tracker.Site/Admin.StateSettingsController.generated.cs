...
namespace Tracker.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_StateSettingsController : Tracker.Areas.Admin.Controllers.StateSettingsController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.Areas.Admin.Models.State.StateSettingsModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(long id, Tracker.Areas.Admin.Models.State.StateSettingsModel model)
        {
