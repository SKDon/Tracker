...
namespace Tracker.Controllers.Application
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ApplicationController : Tracker.Controllers.Application.ApplicationController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.Application.ApplicationAdminModel model, Tracker.ViewModels.TransitEditModel transitModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long id, Tracker.ViewModels.Application.ApplicationAdminModel model, Tracker.ViewModels.TransitEditModel transitModel)
        {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long clientId, Tracker.ViewModels.Application.ApplicationAdminModel model, Tracker.ViewModels.TransitEditModel transitModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(long clientId, Tracker.ViewModels.Application.ApplicationAdminModel model, Tracker.ViewModels.TransitEditModel transitModel)
        {
