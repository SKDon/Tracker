...
namespace Tracker.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EmailTemplateController : Tracker.Controllers.EmailTemplateController
    {
        public T4MVC_EmailTemplateController() : base(Dummy.Instance) { }

        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ViewResult callInfo, Tracker.DataAccess.Contracts.Enums.EventType id, string lang);

        [NonAction]
        public override System.Web.Mvc.ViewResult Edit(Tracker.DataAccess.Contracts.Enums.EventType id, string lang)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.ViewModels.EmailTemplate.EventTemplateModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Tracker.ViewModels.EmailTemplate.EventTemplateModel model)
        {
