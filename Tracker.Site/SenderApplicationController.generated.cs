...
namespace Tracker.Controllers.Application
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SenderApplicationController : Tracker.Controllers.Application.SenderApplicationController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.Application.ApplicationSenderModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(long id, Tracker.ViewModels.Application.ApplicationSenderModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.Application.ApplicationSenderModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long id, Tracker.ViewModels.Application.ApplicationSenderModel model)
        {
