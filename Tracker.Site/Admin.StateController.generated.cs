...
namespace Tracker.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_StateController : Tracker.Areas.Admin.Controllers.StateController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.Areas.Admin.Models.State.StateCreateModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Tracker.Areas.Admin.Models.State.StateCreateModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.Areas.Admin.Models.State.StateEditModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Tracker.Areas.Admin.Models.State.StateEditModel model)
        {
