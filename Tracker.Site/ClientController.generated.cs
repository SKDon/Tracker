...
namespace Tracker.Controllers.User
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ClientController : Tracker.Controllers.User.ClientController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.ViewModels.User.ClientModel model, Tracker.ViewModels.TransitEditModel transitModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Tracker.ViewModels.User.ClientModel model, Tracker.ViewModels.TransitEditModel transitModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long? id, Tracker.ViewModels.User.ClientModel model, Tracker.ViewModels.TransitEditModel transitModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long? id, Tracker.ViewModels.User.ClientModel model, Tracker.ViewModels.TransitEditModel transitModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
