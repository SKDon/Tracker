...
namespace Tracker.Controllers.User
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SenderController : Tracker.Controllers.User.SenderController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.ViewModels.User.SenderModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Tracker.ViewModels.User.SenderModel model)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.User.SenderModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long id, Tracker.ViewModels.User.SenderModel model)
        {
