...
namespace Tracker.Controllers.User
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AuthenticationController : Tracker.Controllers.User.AuthenticationController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Tracker.ViewModels.User.SignIdModel user);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(Tracker.ViewModels.User.SignIdModel user)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
