...
namespace Tracker.Controllers.Awb
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdminAwbController : Tracker.Controllers.Awb.AdminAwbController
    {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long id, Tracker.ViewModels.AirWaybill.AwbAdminModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(long id, Tracker.ViewModels.AirWaybill.AwbAdminModel model)
        {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long? applicationId, Tracker.ViewModels.AirWaybill.AwbAdminModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(long? applicationId, Tracker.ViewModels.AirWaybill.AwbAdminModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "applicationId", applicationId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
