...
public static partial class MVC
{
    ...
    public static Tracker.Controllers.Application.ApplicationController Application = new Tracker.Controllers.Application.T4MVC_ApplicationController();
    public static Tracker.Controllers.Application.ApplicationFilesController ApplicationFiles = new Tracker.Controllers.Application.T4MVC_ApplicationFilesController();
    public static Tracker.Controllers.Application.ApplicationListController ApplicationList = new Tracker.Controllers.Application.T4MVC_ApplicationListController();
    public static Tracker.Controllers.Application.ApplicationPrintController ApplicationPrint = new Tracker.Controllers.Application.T4MVC_ApplicationPrintController();
    public static Tracker.Controllers.Application.ApplicationUpdateController ApplicationUpdate = new Tracker.Controllers.Application.T4MVC_ApplicationUpdateController();
    public static Tracker.Controllers.Application.ClientApplicationController ClientApplication = new Tracker.Controllers.Application.T4MVC_ClientApplicationController();
    public static Tracker.Controllers.Application.SenderApplicationController SenderApplication = new Tracker.Controllers.Application.T4MVC_SenderApplicationController();
    public static Tracker.Controllers.Awb.AdminAwbController AdminAwb = new Tracker.Controllers.Awb.T4MVC_AdminAwbController();
    public static Tracker.Controllers.Awb.AirWaybillController AirWaybill = new Tracker.Controllers.Awb.T4MVC_AirWaybillController();
    public static Tracker.Controllers.Awb.AwbFilesController AwbFiles = new Tracker.Controllers.Awb.T4MVC_AwbFilesController();
    public static Tracker.Controllers.Awb.BrokerAwbController BrokerAwb = new Tracker.Controllers.Awb.T4MVC_BrokerAwbController();
    public static Tracker.Controllers.Awb.SenderAwbController SenderAwb = new Tracker.Controllers.Awb.T4MVC_SenderAwbController();
    public static Tracker.Controllers.Calculation.BalanceController Balance = new Tracker.Controllers.Calculation.T4MVC_BalanceController();
    public static Tracker.Controllers.Calculation.CalculationController Calculation = new Tracker.Controllers.Calculation.T4MVC_CalculationController();
    public static Tracker.Controllers.Calculation.ClientCalculationController ClientCalculation = new Tracker.Controllers.Calculation.T4MVC_ClientCalculationController();
    public static Tracker.Controllers.Calculation.RegistryOfPaymentsController RegistryOfPayments = new Tracker.Controllers.Calculation.T4MVC_RegistryOfPaymentsController();
    public static Tracker.Controllers.Calculation.SenderCalculationController SenderCalculation = new Tracker.Controllers.Calculation.T4MVC_SenderCalculationController();
    public static Tracker.Controllers.ChatController Chat = new Tracker.Controllers.T4MVC_ChatController();
    public static Tracker.Controllers.CityController City = new Tracker.Controllers.T4MVC_CityController();
    public static Tracker.Controllers.CountryController Country = new Tracker.Controllers.T4MVC_CountryController();
    public static Tracker.Controllers.DynamicScriptController DynamicScript = new Tracker.Controllers.T4MVC_DynamicScriptController();
    public static Tracker.Controllers.EmailTemplateController EmailTemplate = new Tracker.Controllers.T4MVC_EmailTemplateController();
    public static Tracker.Controllers.ExcelController Excel = new Tracker.Controllers.T4MVC_ExcelController();
    public static Tracker.Controllers.HomeController Home = new Tracker.Controllers.T4MVC_HomeController();
    public static Tracker.Controllers.TransitController Transit = new Tracker.Controllers.T4MVC_TransitController();
    public static Tracker.Controllers.User.AuthenticationController Authentication = new Tracker.Controllers.User.T4MVC_AuthenticationController();
    public static Tracker.Controllers.User.CarrierController Carrier = new Tracker.Controllers.User.T4MVC_CarrierController();
    public static Tracker.Controllers.User.ClientController Client = new Tracker.Controllers.User.T4MVC_ClientController();
    public static Tracker.Controllers.User.ForwarderUserController ForwarderUser = new Tracker.Controllers.User.T4MVC_ForwarderUserController();
    public static Tracker.Controllers.User.RestorePasswordController RestorePassword = new Tracker.Controllers.User.T4MVC_RestorePasswordController();
    public static Tracker.Controllers.User.SenderController Sender = new Tracker.Controllers.User.T4MVC_SenderController();
    public static Tracker.Controllers.User.UserController User = new Tracker.Controllers.User.T4MVC_UserController();
...
namespace T4MVC
{
    ...
    public class AdminClass
    {
        ...
        public Tracker.Areas.Admin.Controllers.BillController Bill = new Tracker.Areas.Admin.Controllers.T4MVC_BillController();
        public Tracker.Areas.Admin.Controllers.BillSettingsController BillSettings = new Tracker.Areas.Admin.Controllers.T4MVC_BillSettingsController();
        public Tracker.Areas.Admin.Controllers.StateController State = new Tracker.Areas.Admin.Controllers.T4MVC_StateController();
        public Tracker.Areas.Admin.Controllers.StateSettingsController StateSettings = new Tracker.Areas.Admin.Controllers.T4MVC_StateSettingsController();
    ...
    public class ForwarderClass
    {
        ...
        public Tracker.Areas.Forwarder.Controllers.ApplicationsController Applications = new Tracker.Areas.Forwarder.Controllers.T4MVC_ApplicationsController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class app {
            ...
            public static readonly string Tracker_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Tracker.min.js") ? Url("Tracker.min.js") : Url("Tracker.js");
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public static partial class Scripts 
        {
            public static partial class app 
            {
                ...
                public static class Assets
                {
                    ...
                    public const string Tracker_js = "~/Scripts/app/Tracker.js"; 
                }
            }
